...
import { IpGalleryComponent } from './ip-gallery/ip-gallery.component';
...
export const routes: Routes = [
  ...
  { path: 'our-gallery', component: IpGalleryComponent, title: 'Our Gallery | Adv KJ Thomas Kallampally Thiruvananthapuram' },
